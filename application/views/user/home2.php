<section class="slide1">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="<?php echo base_url('assets/member/')?>images/banner-10.jpg" alt="IMG-BENNER">
	...
	<!-- Banner video -->
	<section class="parallax0 parallax100" style="background-image: url(<?php echo base_url('assets/member/')?>images/bg-video-01.jpg);">
